...
static bool dynamic_init_dummy_dbg_2fpeval_2femit_2fgemitter_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_dbg_2fpeval_2femit_2fgemitter_2eproto), true);
namespace gemitter {
