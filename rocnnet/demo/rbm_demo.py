...
def main(args):
    ...
    parser.add_argument('--load', dest='load', nargs='?', default='rocnnet/pretrained/rbmmodel.pbx',
        help='Filename to load pretrained model (default: rocnnet/pretrained/rbmmodel.pbx)')
