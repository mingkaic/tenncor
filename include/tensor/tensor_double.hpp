 ...
 *
 *  Purpose:
 *  double implementation of tensor
 *
...
#pragma once
#ifndef TENNCOR_TENSOR_DOUBLE_HPP
#define TENNCOR_TENSOR_DOUBLE_HPP
...
class tensor_double : public itensor
{
public:
	...
	tensor_double (double scalar, size_t alloc_id = default_alloc::alloc_id);
	...
	std::vector<double> expose (void) const;

	//! get data at coordinate specified
	double get (std::vector<size_t> coord) const;
...
private:
	tensor<double> content_;
};

}

#endif /* TENNCOR_TENSOR_DOUBLE_HPP */
