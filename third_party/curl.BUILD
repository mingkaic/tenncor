# source: https://github.com/tensorflow/tensorflow/blob/master/third_party/curl.BUILD
# Description:
...
cc_library(
    ...
    srcs = [
        ...
        "@com_github_mingkaic_tenncor//:macos": [
            "lib/vtls/sectransp.c",
        ],
        "@com_github_mingkaic_tenncor//:ios": [
            "lib/vtls/sectransp.c",
        ],
        "@com_github_mingkaic_tenncor//:windows": CURL_WIN_SRCS,
        "//conditions:default": [
            "lib/vtls/openssl.c",
        ],
    }),
    ...
    copts = select({
        "@com_github_mingkaic_tenncor//:windows": CURL_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DBUILDING_LIBCURL",
        ...
        "@com_github_mingkaic_tenncor//:windows": [
    ...
    linkopts = select({
        # "@com_github_mingkaic_tenncor//:android": [
        #     "-pie",
        # ],
        "@com_github_mingkaic_tenncor//:macos": [
            "-Wl,-framework",
...
cc_binary(
    ...
    copts = select({
        "@com_github_mingkaic_tenncor//:windows": CURL_BIN_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DHAVE_CONFIG_H",
