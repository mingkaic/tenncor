...
template <typename T=float>
static eteq::ETensor tc_sigmoid (const eteq::ETensor& x)
{
...
TEST_F(LAYER_DISTRIB, DISABLED_DenseQuery)
{
	{
		eigen::Device device;
		...
		auto detections = lusvc.query({dense_ref}, leaf_cond);
...
TEST_F(LAYER_DISTRIB, DISABLED_DenseConnection)
{
	{
		eigen::Device device;
		teq::Shape inshape({6, 2});
		...
		auto xa = eteq::make_variable_scalar<float>(0, inshape, "xa", actx);
		...
		auto dense_ref = tcr::lookup_node(dense_id, bctx);
		auto xb = eteq::make_variable_scalar<float>(0, inshape, "xb", bctx);
...
TEST(DENSE, Connection)
{
	...
	auto x2 = eteq::make_variable_scalar<float>(
		0, teq::Shape({7, 2}), "x2");
	auto biasedy = layr::connect(biased_dense, eteq::ETensor(x));
	auto y = layr::connect(dense, eteq::ETensor(x2));
...
TEST(CONV, Connection)
{
	...
	auto y = layr::connect(conv, eteq::ETensor(x));
...
TEST(RBM, Connection)
{
	...
	auto biasedy = rrbm.connect(eteq::ETensor(x));
	auto y = nobias.connect(eteq::ETensor(x2));
	...
	EXPECT_GRAPHEQ(
		...
		"_____|___`--(variable:weight<FLOAT>[5\\6\\1\\1\\1\\1\\1\\1])\n"
		"_____`--(EXTEND<FLOAT>[5\\2\\1\\1\\1\\1\\1\\1])\n"
		"_________`--(variable:hbias<FLOAT>[5\\1\\1\\1\\1\\1\\1\\1])", biasedy);
...
TEST(RBM, BackwardConnection)
{
	...
	auto biasedx = rrbm.backward_connect(eteq::ETensor(y));
	auto x = nobias.backward_connect(eteq::ETensor(y2));
	...
	EXPECT_GRAPHEQ(
		...
		"_____`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_________`--(variable:vbias<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])", biasedx);
...
TEST(BIND, Sigmoid)
{
	...
	EXPECT_GRAPHEQ(
		"(IDENTITY<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_`--(SIGMOID<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])", s);
}
...
TEST(BIND, Softmax)
{
	...
	auto x = eteq::make_variable_scalar<float>(0, teq::Shape({6, 2}), "x");
	auto s0 = layr::connect(sft0, eteq::ETensor(x));
	auto s1 = layr::connect(sft1, eteq::ETensor(x));

	std::string eps_str = fmts::to_string(std::numeric_limits<float>::epsilon());
	auto expect_str0 = fmts::sprintf(
		"(IDENTITY<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_`--(DIV<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____`--(EXP<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|___`--(SUB<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|_______`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|_______`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|___________`--(REDUCE_MAX<FLOAT>[1\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|_______________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_________`--(ADD<FLOAT>[1\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________`--(REDUCE_SUM<FLOAT>[1\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___`--(EXP<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|_______`--(SUB<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|_______________`--(REDUCE_MAX<FLOAT>[1\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________`--(EXTEND<FLOAT>[1\\2\\1\\1\\1\\1\\1\\1])\n"
		"_________________`--(constant:%s<FLOAT>[1\\1\\1\\1\\1\\1\\1\\1])", eps_str.c_str());
	...
	auto expect_str1 = fmts::sprintf(
		...
		"_____|_______`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|_______`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____|___________`--(REDUCE_MAX<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])\n"
		"_____|_______________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_________`--(ADD<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])\n"
		"_____________`--(REDUCE_SUM<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___`--(EXP<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|_______`--(SUB<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________`--(EXTEND<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________|_______________`--(REDUCE_MAX<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])\n"
		"_____________|___________________`--(variable:x<FLOAT>[6\\2\\1\\1\\1\\1\\1\\1])\n"
		"_____________`--(EXTEND<FLOAT>[6\\1\\1\\1\\1\\1\\1\\1])\n"
		"_________________`--(constant:%s<FLOAT>[1\\1\\1\\1\\1\\1\\1\\1])", eps_str.c_str());
...
TEST(CONNECT, TanhRNN)
{
	...
	eteq::ETensor in = eteq::ETensor(
		eteq::make_variable<double>(in_data.data(), in_shape));
	eteq::ETensor out = eteq::ETensor(
		eteq::make_variable<double>(out_data.data(), out_shape));

	auto layer = tenncor().layer.rnn<double>(indim, hidden_dim, tc_tanh<double>, nseq,
...
TEST(CONNECT, DenseTanhRNN)
{
	...
	auto rnn = tenncor().layer.rnn<double>(hidden_dim, hidden_dim, tc_tanh<double>, nseq,
		[&](teq::Shape wshape, std::string label)
		{
	...
	auto layer = tenncor().layer.link({indense, rnn});
	...
	auto ders = tcr::derive(err, {
		eteq::ETensor(weight1),
		eteq::ETensor(bias1),
		eteq::ETensor(istate),
		eteq::ETensor(weight0),
		eteq::ETensor(bias0),
	});
	auto dw1 = ders[0];
	auto db1 = ders[1];
...
TEST(CONNECT, TanhRNNTraining)
{
	...
	{
		auto right = eteq::ETensor(targets[i]) + momentum_tmps[i];
	...
	for (size_t i = 0; i < nders; ++i)
	{
		auto right = lmbd * eteq::ETensor(mvavg_sqrs[i]) +
	...
	eteq::ETensorsT group3_right;
	{
		...
		for (size_t i = 0; i < nders; ++i)
		{
			pgrad_norm_nodes.push_back((learning_rate * ders[i]) /
				(tenncor().sqrt(eteq::ETensor(mvavg_sqrs[i])) + eps));
		}
		...
		for (size_t i = 0; i < nders; ++i)
		{
			auto right = eteq::ETensor(targets[i]) - pgrad_norm_nodes[i];
